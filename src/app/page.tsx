  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="relative overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-b from-[#2d8a4e]/10 to-transparent" />
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 relative">
          <div className="text-center max-w-3xl mx-auto">
            <h1 className="text-4xl sm:text-5xl font-bold text-white mb-6">
              Gaimchanger Golf
              <span className="block text-[#2d8a4e] mt-1">Corporate HQ</span>
            </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {agents.map((agent) => (
            <Link
              ...
              className="group block p-6 bg-neutral-900/50 border border-neutral-800 rounded-xl hover:border-[#2d8a4e]/50 hover:bg-neutral-900 transition-all"
            >
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 max-w-2xl">
          <Link
            href="/dashboard"
            className="flex items-center gap-4 p-5 bg-neutral-900/50 border border-neutral-800 rounded-xl hover:border-[#2d8a4e]/50 transition-all group"
          >
            <div className="w-10 h-10 bg-[#2d8a4e]/10 border border-[#2d8a4e]/20 rounded-lg flex items-center justify-center text-[#2d8a4e]">
